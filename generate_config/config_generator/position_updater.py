...
class PositionUpdater:
    ...
    def update_positions(self, template: Dict[str, Any], quantity_data: QuantityAnalysisData) -> Dict[str, Any]:
        """
        Update both start_row and column positions in a single operation.
        ...
        Returns:
            Updated template with both start_row and column positions updated
        """
        # First update start rows
        updated_template = self.update_start_rows(template, quantity_data)
        
        # Then update column positions
        updated_template = self.update_column_positions(updated_template, quantity_data)
